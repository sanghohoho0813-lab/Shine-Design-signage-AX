...
export const FAQS = [
  ...
  {
    q: "전국 어디든 시공이 가능한가요?",
    a: "가능합니다. 최근에도 원주·울산·마산·예산·보령·제주·광양 등 전국 현장을 수행했습니다. 화성 공장에서 제작하고, 현장 조건에 맞는 시공팀을 구성해 진행합니다.",
  },
  {
    q: "장애인 편의시설(BF) 사인도 함께 되나요?",
    a: "됩니다. 장애인 종합안내 촉지도, 장애인주차구역 표지판·유도표지판, 음성유도 표지판, 장애인화장실 사인, 구조 촉지도, 핸드레일 점자 사인을 자체 품목으로 보유하고 있습니다. 일반 사인과 BF 사인을 한 업체에서 처리해 규격·서체·색상이 어긋나지 않습니다.",
  },
  {
  ...
  },
  {
    ...
    a: "산업디자인전문회사 신고, 직접생산확인증명서, 옥외광고사업 등록, 공장등록, 여성기업 확인, 창업기업 확인, 중소기업 확인을 보유하고 있습니다. 특히 직접생산확인은 간판·광고물 제조업을 포함한 7개 품목에 등재되어 있어 조달 계약 시 직접생산 요건을 충족합니다. 입찰 제출용 서류는 요청 시 준비해 드립니다.",
  },
  {
    q: "기간은 보통 얼마나 걸리나요?",
