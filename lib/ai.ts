...
export const AI_ENGINES: AiEngine[] = [
  ...
  },
  {
    id: "schedule",
    name: "Schedule Guard",
    question: "이번 달 어느 날 설치·납기가 겹치고, 무엇이 이미 늦었는가?",
    inputs: ["프로젝트 납기", "제작 발주 납기", "발주 상태·검수", "납기 변경 이력"],
    does: ["같은 날 설치·납기 2건 이상이면 겹침으로 표시", "납기가 지났는데 완료되지 않은 건을 목록화", "제작 납기가 프로젝트 납기보다 늦은 발주를 잡음"],
    why: "전국 현장이 동시에 돌아가 일정이 겹치면 납기가 바로 밀리는데, 지금은 머릿속과 수첩에만 있기 때문에.",
    method: "RULE",
    level: "L2",
    errorCost: "MID",
    approval: "납기 변경은 사람이 사유와 함께 기록 — 화면은 경고만",
    now: "날짜 비교(겹침·지남·제작납기 > 프로젝트납기)",
    next: "시공팀·차량·장비 배정을 넣은 뒤 일정 최적화(OPTIMIZATION)",
    evidence: "SCHEDULE — 납기 변경 사유 이력 · RISK — 겹침 경고",
  },
  {
    id: "next",
    name: "Next Action",
